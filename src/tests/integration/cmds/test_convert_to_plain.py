# AUTOGENERATED! DO NOT EDIT! File to edit: pts/tests/integration/cmds/test_convert_to_plain.pct.py

__all__ = ['converted', 'data_of', 'fingerprint', 'fmt', 'peer_sync', 'pytestmark', 'reverse_upto', 'run', 'test_a_box_with_a_virtualenv_can_be_reversed', 'test_a_peer_that_still_reads_restic_does_not_lose_the_repository', 'test_a_second_machine_can_adopt_the_reverted_box', 'test_dry_run_changes_nothing', 'test_every_interrupted_state_still_works_and_recovers', 'test_it_refuses_a_local_tree_that_does_not_match_the_snapshot', 'test_it_refuses_when_restic_is_missing', 'test_it_refuses_while_the_box_is_being_synced', 'test_plain_to_restic_to_plain_is_byte_identical', 'test_reversing_a_plain_box_is_a_no_op', 'test_the_box_still_syncs_afterwards', 'test_the_format_is_PUBLISHED_not_just_saved_locally', 'test_the_publish_happens_BEFORE_the_repository_is_removed', 'test_the_remote_is_a_plain_tree_again', 'test_the_reversal_leaves_excluded_content_alone']

# %% pts/tests/integration/cmds/test_convert_to_plain.pct.py 2
import asyncio
import hashlib
import os
import shutil
...
# %% pts/tests/integration/cmds/test_convert_to_plain.pct.py 3
@pytest.fixture
...
# %% pts/tests/integration/cmds/test_convert_to_plain.pct.py 5
...
# %% pts/tests/integration/cmds/test_convert_to_plain.pct.py 7
...
# %% pts/tests/integration/cmds/test_convert_to_plain.pct.py 9
...
# %% pts/tests/integration/cmds/test_convert_to_plain.pct.py 11
