...
__all__ = ['test_delete_aborts_when_the_remote_purge_fails', 'test_delete_removes_sync_records', 'test_delete_succeeds_when_the_remote_paths_were_never_there', 'test_remove_parent_drops_dangling_parent', 'test_remove_parent_reports_when_not_a_parent']
...
# %% pts/tests/integration/cmds/test_delete_and_parent_cleanup.pct.py 6
@pytest.mark.integration
...
# %% pts/tests/integration/cmds/test_delete_and_parent_cleanup.pct.py 7
@pytest.mark.integration
