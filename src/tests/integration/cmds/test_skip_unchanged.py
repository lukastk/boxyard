# AUTOGENERATED! DO NOT EDIT! File to edit: pts/tests/integration/cmds/test_skip_unchanged.pct.py

__all__ = ['metas', 'needs_restic', 'pointer_entry', 'pytestmark', 'run', 'test_a_box_missing_from_the_listing_is_never_skipped', 'test_a_box_with_no_check_record_is_never_skipped', 'test_a_converted_unchanged_box_is_skippable', 'test_a_locally_modified_box_is_never_skipped', 'test_a_lone_deletion_is_never_skipped', 'test_a_moved_pointer_is_never_skipped', 'test_a_plain_box_is_never_skippable_for_data', 'test_an_interrupted_restore_is_never_skipped', 'test_meta_evidence_alone_does_not_skip_a_data_sync', 'test_one_listing_returns_both_files_at_depth_2', 'test_the_data_flag_does_not_switch_on_meta_skipping', 'test_the_listing_must_be_keyed_by_box_and_filename', 'test_the_real_bulk_listing_keeps_the_two_files_apart', 'test_the_real_filter_admits_the_pointer', 'yard']

# %% pts/tests/integration/cmds/test_skip_unchanged.pct.py 2
import asyncio
import shutil
...
# %% pts/tests/integration/cmds/test_skip_unchanged.pct.py 4
...
# %% pts/tests/integration/cmds/test_skip_unchanged.pct.py 6
@pytest.fixture
...
# %% pts/tests/integration/cmds/test_skip_unchanged.pct.py 7
...
# %% pts/tests/integration/cmds/test_skip_unchanged.pct.py 9
@needs_restic
...
# %% pts/tests/integration/cmds/test_skip_unchanged.pct.py 11
...
# %% pts/tests/integration/cmds/test_skip_unchanged.pct.py 13
@needs_restic
...
# %% pts/tests/integration/cmds/test_skip_unchanged.pct.py 15
@needs_restic
