# AUTOGENERATED! DO NOT EDIT! File to edit: pts/tests/integration/cmds/test_doctor_sync_policy.pct.py

__all__ = ['TORN', 'test_a_clean_yard_reports_no_policy_findings', 'test_a_torn_box_is_reported', 'test_an_unreadable_box_sync_conf_is_reported', 'test_doctor_does_not_crash_on_a_torn_box', 'test_two_policies_agreeing_is_not_reported']

# %% pts/tests/integration/cmds/test_doctor_sync_policy.pct.py 2
import asyncio
...
# %% pts/tests/integration/cmds/test_doctor_sync_policy.pct.py 3
