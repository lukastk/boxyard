# AUTOGENERATED! DO NOT EDIT! File to edit: pts/tests/integration/cmds/test_new_parent_forms.pct.py

__all__ = ['test_new_parent_accepts_every_documented_form']

# %% pts/tests/integration/cmds/test_new_parent_forms.pct.py 3
import subprocess
import sys
import tomllib
...
# %% pts/tests/integration/cmds/test_new_parent_forms.pct.py 5
