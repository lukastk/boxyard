...
__all__ = ['CHARSET', 'TestIsValidIndexName', 'test_a_discard_local_keepsake_matches_the_orphan_predicate', 'test_doctor_broken_registration', 'test_doctor_cli_exit_codes_and_json', 'test_doctor_dangling_symlinks', 'test_doctor_duplicate_box_id', 'test_doctor_group_tree_debris', 'test_doctor_healthy_on_empty_remote', 'test_doctor_healthy_yard', 'test_doctor_healthy_yard_has_no_backup_findings', 'test_doctor_interrupted_sync', 'test_doctor_is_read_only', 'test_doctor_leaves_a_backup_an_incomplete_sync_still_names', 'test_doctor_orphaned_local_sync_backups', 'test_doctor_orphaned_remote_sync_backups', 'test_doctor_orphaned_sync_records', 'test_doctor_rclone_binary_unresolvable', 'test_doctor_rclone_config', 'test_doctor_remote_backups_check_is_skipped_offline', 'test_doctor_reports_non_ulid_entries_as_debris', 'test_doctor_stale_cache', 'test_doctor_stale_meta_mirror', 'test_doctor_tombstoned_box', 'test_doctor_tree_orphans', 'test_doctor_unknown_storage_location', 'test_doctor_unregistered_and_malformed', 'test_the_orphan_hint_says_what_the_finding_does_not_prove']
...
# %% pts/tests/integration/cmds/test_doctor.pct.py 23
@pytest.mark.integration
...
# %% pts/tests/integration/cmds/test_doctor.pct.py 24
@pytest.mark.integration
