...
__all__ = ['test_a_newer_key_does_not_cost_the_box_its_registration', 'test_a_newer_key_survives_add_to_group', 'test_an_unknown_config_key_does_not_stop_doctor_running', 'test_machine_name_from_the_environment_satisfies_the_check', 'test_machine_name_unset_reported', 'test_unknown_boxmeta_keys_reported', 'test_unknown_config_keys_reported']
