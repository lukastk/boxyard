...
__all__ = ['test_a_newer_key_does_not_cost_the_box_its_registration', 'test_a_newer_key_survives_add_to_group', 'test_an_unknown_config_key_does_not_stop_doctor_running', 'test_an_unknown_nested_config_key_does_not_stop_boxyard_working', 'test_machine_name_from_the_environment_satisfies_the_check', 'test_machine_name_unset_reported', 'test_no_finding_when_the_base_matches', 'test_no_finding_without_a_base', 'test_unknown_boxmeta_keys_reported', 'test_unknown_config_keys_reported', 'test_unknown_nested_config_key_reported_with_its_path', 'test_unpushed_meta_edit_reported']
