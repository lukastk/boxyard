...
__all__ = ['findings', 'hint_for', 'load', 'pytestmark', 'set_policies', 'test_a_conflicted_policy_is_reported_once_not_twice', 'test_a_policy_asking_for_restic_is_reported', 'test_no_finding_on_a_default_yard', 'test_no_finding_when_policy_and_reality_agree', 'test_running_doctor_does_not_convert_anything', 'test_the_finding_names_where_the_intent_came_from', 'test_the_hint_for_a_plain_box_offers_convert', 'test_the_hint_for_a_restic_box_says_there_is_no_route_back', 'test_the_hint_names_the_conversion_command', 'test_the_hint_warns_that_old_machines_cannot_read_a_converted_box', 'test_the_reverse_direction_is_reported_too', 'yard']
...
# %% pts/tests/integration/cmds/test_doctor_storage_format.pct.py 13
def hint_for(yard):
    found = findings(yard, "storage-format-mismatch")
