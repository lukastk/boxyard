...
__all__ = ['test_a_box_holding_only_unmeasurable_content_is_not_an_error', 'test_a_lone_deletion_plus_a_remote_advance_reads_conflict_not_needs_pull', 'test_a_lone_deletion_reads_needs_push_and_actually_propagates']
...
# %% pts/tests/integration/sync/test_lone_changes_propagate.pct.py 8
@pytest.mark.integration
