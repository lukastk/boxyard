...
__all__ = ['PERMS_MANIFEST', 'converted_on_A', 'data_of', 'fingerprint', 'get_config_', 'pytestmark', 'run', 'test_a_chmod_only_change_pushes', 'test_a_symlink_only_change_pushes_and_reaches_the_other_machine', 'test_an_excluded_box_is_still_left_alone', 'test_copy_from_remote_works_on_a_converted_box', 'test_discard_local_works_on_a_converted_box', 'test_include_materialises_a_converted_box_on_a_second_machine', 'test_include_refuses_when_restic_is_missing', 'test_retargeting_a_symlink_and_nothing_else_pushes', 'test_sync_does_not_send_the_person_back_to_include', 'test_the_adopted_box_is_immediately_settled', 'test_the_adopting_machine_can_then_push']
...
# %% pts/tests/integration/sync/test_restic_adoption.pct.py 11
