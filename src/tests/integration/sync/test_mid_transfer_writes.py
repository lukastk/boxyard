# AUTOGENERATED! DO NOT EDIT! File to edit: pts/tests/integration/sync/test_mid_transfer_writes.pct.py

__all__ = ['test_a_file_written_during_a_pull_is_not_blessed_and_not_later_deleted', 'test_a_file_written_during_a_push_is_not_blessed_as_pushed', 'test_a_quiet_pull_still_records_a_usable_baseline']

# %% pts/tests/integration/sync/test_mid_transfer_writes.pct.py 3
import asyncio
import json
import tempfile
...
# %% pts/tests/integration/sync/test_mid_transfer_writes.pct.py 4
...
# %% pts/tests/integration/sync/test_mid_transfer_writes.pct.py 5
...
# %% pts/tests/integration/sync/test_mid_transfer_writes.pct.py 6
@pytest.mark.integration
...
# %% pts/tests/integration/sync/test_mid_transfer_writes.pct.py 7
@pytest.mark.integration
