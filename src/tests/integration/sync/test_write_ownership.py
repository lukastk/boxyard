# AUTOGENERATED! DO NOT EDIT! File to edit: pts/tests/integration/sync/test_write_ownership.pct.py

__all__ = ['Fleet', 'run', 'test_a_non_owner_in_conflict_is_denied_not_raised', 'test_claim_all_included_claims_every_unowned_included_box', 'test_claim_all_included_refuses_to_be_combined_with_steal', 'test_claim_all_included_reports_the_boxes_that_refuse_without_stopping', 'test_claim_all_included_skips_boxes_in_a_local_storage_location', 'test_claim_fails_loudly_when_it_did_not_stick', 'test_claim_on_an_already_owned_box_refuses_and_names_the_owner', 'test_claim_on_an_included_box_still_works', 'test_claim_refuses_a_box_that_is_not_included_here', 'test_conf_probe_clean_baseline_converges_instead_of_reprobing_forever', 'test_data_only_sync_still_sees_a_fresh_claim', 'test_discard_local_leaves_a_recoverable_backup', 'test_discard_local_then_sync_is_quiet', 'test_doctor_is_quiet_about_a_glob_excluded_file_too', 'test_exclude_of_a_box_owned_by_another_machine_is_unchanged', 'test_exclude_on_an_owned_box_releases_ownership', 'test_exclude_with_an_unreachable_remote_refuses_and_does_not_exclude', 'test_excluded_debris_does_not_look_like_a_local_change', 'test_force_push_does_not_bypass_ownership', 'test_non_owner_pulls_the_owners_changes', 'test_non_owner_with_a_clean_box_syncs_quietly', 'test_non_owner_with_real_changes_is_write_denied', 'test_release_refuses_a_box_owned_by_another_machine', 'test_release_returns_the_boxmeta_to_its_pre_v05_form', 'test_release_rolls_back_when_the_push_did_not_land', 'test_release_then_claim_elsewhere_is_a_clean_handover', 'test_stale_owner_is_quiet_when_ownership_is_healthy', 'test_stale_owner_reports_a_box_we_own_but_do_not_have', 'test_steal_takes_the_box_and_the_previous_owner_is_then_denied', 'test_sync_setting_force_does_not_bypass_ownership', 'test_the_probe_is_what_saves_a_glob_excluded_file', 'test_unowned_box_is_unrestricted', 'test_write_denied_is_not_an_error_for_multi_sync', 'test_write_denied_is_quiet_for_debris_only', 'test_write_denied_is_reported_by_doctor_with_both_ways_out', 'test_write_denied_names_the_owner_and_both_ways_out']

# %% pts/tests/integration/sync/test_write_ownership.pct.py 2
import asyncio
import tomllib
...
# %% pts/tests/integration/sync/test_write_ownership.pct.py 3
...
# %% pts/tests/integration/sync/test_write_ownership.pct.py 4
@pytest.mark.integration
...
# %% pts/tests/integration/sync/test_write_ownership.pct.py 5
@pytest.mark.integration
...
# %% pts/tests/integration/sync/test_write_ownership.pct.py 6
@pytest.mark.integration
...
# %% pts/tests/integration/sync/test_write_ownership.pct.py 7
@pytest.mark.integration
...
# %% pts/tests/integration/sync/test_write_ownership.pct.py 8
@pytest.mark.integration
...
# %% pts/tests/integration/sync/test_write_ownership.pct.py 9
@pytest.mark.integration
...
# %% pts/tests/integration/sync/test_write_ownership.pct.py 10
@pytest.mark.integration
...
# %% pts/tests/integration/sync/test_write_ownership.pct.py 11
@pytest.mark.integration
...
# %% pts/tests/integration/sync/test_write_ownership.pct.py 12
@pytest.mark.integration
...
# %% pts/tests/integration/sync/test_write_ownership.pct.py 13
@pytest.mark.integration
...
# %% pts/tests/integration/sync/test_write_ownership.pct.py 14
@pytest.mark.integration
...
# %% pts/tests/integration/sync/test_write_ownership.pct.py 15
@pytest.mark.integration
...
# %% pts/tests/integration/sync/test_write_ownership.pct.py 16
@pytest.mark.integration
...
# %% pts/tests/integration/sync/test_write_ownership.pct.py 17
@pytest.mark.integration
...
# %% pts/tests/integration/sync/test_write_ownership.pct.py 18
@pytest.mark.integration
...
# %% pts/tests/integration/sync/test_write_ownership.pct.py 19
@pytest.mark.integration
...
# %% pts/tests/integration/sync/test_write_ownership.pct.py 20
@pytest.mark.integration
...
# %% pts/tests/integration/sync/test_write_ownership.pct.py 21
@pytest.mark.integration
...
# %% pts/tests/integration/sync/test_write_ownership.pct.py 22
@pytest.mark.integration
...
# %% pts/tests/integration/sync/test_write_ownership.pct.py 23
@pytest.mark.integration
...
# %% pts/tests/integration/sync/test_write_ownership.pct.py 24
@pytest.mark.integration
...
# %% pts/tests/integration/sync/test_write_ownership.pct.py 25
@pytest.mark.integration
...
# %% pts/tests/integration/sync/test_write_ownership.pct.py 26
@pytest.mark.integration
...
# %% pts/tests/integration/sync/test_write_ownership.pct.py 27
@pytest.mark.integration
...
# %% pts/tests/integration/sync/test_write_ownership.pct.py 28
@pytest.mark.integration
...
# %% pts/tests/integration/sync/test_write_ownership.pct.py 29
@pytest.mark.integration
...
# %% pts/tests/integration/sync/test_write_ownership.pct.py 30
@pytest.mark.integration
...
# %% pts/tests/integration/sync/test_write_ownership.pct.py 31
@pytest.mark.integration
...
# %% pts/tests/integration/sync/test_write_ownership.pct.py 32
@pytest.mark.integration
...
# %% pts/tests/integration/sync/test_write_ownership.pct.py 33
@pytest.mark.integration
...
# %% pts/tests/integration/sync/test_write_ownership.pct.py 34
...
# %% pts/tests/integration/sync/test_write_ownership.pct.py 35
@pytest.mark.integration
...
# %% pts/tests/integration/sync/test_write_ownership.pct.py 36
@pytest.mark.integration
...
# %% pts/tests/integration/sync/test_write_ownership.pct.py 37
@pytest.mark.integration
...
# %% pts/tests/integration/sync/test_write_ownership.pct.py 38
@pytest.mark.integration
