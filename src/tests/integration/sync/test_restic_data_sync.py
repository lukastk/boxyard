# AUTOGENERATED! DO NOT EDIT! File to edit: pts/tests/integration/sync/test_restic_data_sync.pct.py

__all__ = ['data_condition', 'data_of', 'pair', 'pytestmark', 'run', 'sync', 'test_a_box_not_included_here_is_excluded_not_pulled', 'test_a_clean_full_check_closes_the_gate_again', 'test_a_deletion_only_change_is_detected', 'test_a_deletion_reaches_the_other_machine', 'test_a_divergence_raises_and_changes_nothing', 'test_a_half_converted_box_reports_error_not_a_guess', 'test_a_local_edit_pushes', 'test_a_non_owner_holding_changes_is_write_denied_not_an_error', 'test_a_non_owner_with_nothing_to_push_still_pulls', 'test_a_plain_box_takes_the_untouched_path', 'test_a_push_that_races_another_reports_conflict_and_keeps_both', 'test_a_replica_in_sync_adopts_cleanly', 'test_a_replica_with_an_unpushed_deletion_refuses_to_adopt', 'test_a_replica_with_unpushed_work_refuses_to_adopt', 'test_an_interrupted_restore_refuses_a_forced_push', 'test_an_interrupted_restore_resumes_instead_of_conflicting', 'test_an_ordinary_push_stamps_agreement_before_the_push', 'test_an_unchanged_box_reports_synced_and_transfers_nothing', 'test_every_part_is_present_in_the_result', 'test_the_board_renders_a_restic_box', 'test_the_exclude_list_still_applies_after_conversion', 'test_the_other_machine_pulls_it', 'tree']

# %% pts/tests/integration/sync/test_restic_data_sync.pct.py 2
import asyncio
import shutil
...
# %% pts/tests/integration/sync/test_restic_data_sync.pct.py 3
@pytest.fixture
...
# %% pts/tests/integration/sync/test_restic_data_sync.pct.py 5
...
# %% pts/tests/integration/sync/test_restic_data_sync.pct.py 7
...
# %% pts/tests/integration/sync/test_restic_data_sync.pct.py 9
...
# %% pts/tests/integration/sync/test_restic_data_sync.pct.py 11
...
# %% pts/tests/integration/sync/test_restic_data_sync.pct.py 13
...
# %% pts/tests/integration/sync/test_restic_data_sync.pct.py 15
...
# %% pts/tests/integration/sync/test_restic_data_sync.pct.py 17
...
# %% pts/tests/integration/sync/test_restic_data_sync.pct.py 19
...
# %% pts/tests/integration/sync/test_restic_data_sync.pct.py 21
...
# %% pts/tests/integration/sync/test_restic_data_sync.pct.py 23
...
# %% pts/tests/integration/sync/test_restic_data_sync.pct.py 25
