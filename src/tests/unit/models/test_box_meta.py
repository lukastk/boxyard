# AUTOGENERATED! DO NOT EDIT! File to edit: pts/tests/unit/models/test_box_meta.pct.py

__all__ = ['TestBoxId', 'TestBoxMetaCreate', 'TestBoxMetaValidation', 'TestBoxPart', 'TestCheckIncluded', 'TestCreateWithExplicitTimestamp', 'TestCreationTimestampDatetime', 'TestCreatorHostnameControlCharacters', 'TestIndexName', 'TestPathGeneration', 'TestValidateGroupName', 'TestValidateGroupNameTrailingNewline']

# %% pts/tests/unit/models/test_box_meta.pct.py 2
import pytest
...
# %% pts/tests/unit/models/test_box_meta.pct.py 3
class TestBoxId:
...
# %% pts/tests/unit/models/test_box_meta.pct.py 4
class TestIndexName:
...
# %% pts/tests/unit/models/test_box_meta.pct.py 5
...
# %% pts/tests/unit/models/test_box_meta.pct.py 6
...
# %% pts/tests/unit/models/test_box_meta.pct.py 7
...
# %% pts/tests/unit/models/test_box_meta.pct.py 8
...
# %% pts/tests/unit/models/test_box_meta.pct.py 9
...
# %% pts/tests/unit/models/test_box_meta.pct.py 10
...
# %% pts/tests/unit/models/test_box_meta.pct.py 11
class TestBoxPart:
...
# %% pts/tests/unit/models/test_box_meta.pct.py 13
...
# %% pts/tests/unit/models/test_box_meta.pct.py 15
...
# %% pts/tests/unit/models/test_box_meta.pct.py 17
