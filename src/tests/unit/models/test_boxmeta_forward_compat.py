# AUTOGENERATED! DO NOT EDIT! File to edit: pts/tests/unit/models/test_boxmeta_forward_compat.pct.py

__all__ = ['INDEX_NAME', 'NEWER_BOXMETA', 'PRE_V05_BOXMETA', 'PRE_V05_FIELDS', 'SL', 'TestUnknownKeyPassthrough', 'TestUnownedBoxmetaIsUnchanged', 'TestWriteOwnerRoundTrip', 'TestWriteOwnerValidation', 'make_config', 'write_boxmeta']

# %% pts/tests/unit/models/test_boxmeta_forward_compat.pct.py 2
import pytest
import tomli_w
...
# %% pts/tests/unit/models/test_boxmeta_forward_compat.pct.py 3
...
# %% pts/tests/unit/models/test_boxmeta_forward_compat.pct.py 4
...
# %% pts/tests/unit/models/test_boxmeta_forward_compat.pct.py 5
...
# %% pts/tests/unit/models/test_boxmeta_forward_compat.pct.py 6
