# AUTOGENERATED! DO NOT EDIT! File to edit: pts/tests/unit/_utils/test_rclone_cmd_builder.pct.py

__all__ = ['TestBisyncResult', 'TestBisyncResultParsing', 'TestComparisonEnvRefusal', 'TestCopytoDryRun', 'TestFilterFamilyRefusal', 'TestRcloneBisyncCommand', 'TestRcloneCat', 'TestRcloneCommandExecution', 'TestRcloneCopyCommand', 'TestRcloneCopytoCommand', 'TestRcloneDelete', 'TestRcloneLsjsonOptions', 'TestRcloneMkdir', 'TestRcloneMove', 'TestRclonePathExists', 'TestRclonePurge', 'TestRclonePurgeAbsentOk', 'TestRcloneSyncCommand']

# %% pts/tests/unit/_utils/test_rclone_cmd_builder.pct.py 2
import pytest
import asyncio
...
# %% pts/tests/unit/_utils/test_rclone_cmd_builder.pct.py 3
...
# %% pts/tests/unit/_utils/test_rclone_cmd_builder.pct.py 4
...
# %% pts/tests/unit/_utils/test_rclone_cmd_builder.pct.py 5
...
# %% pts/tests/unit/_utils/test_rclone_cmd_builder.pct.py 6
...
# %% pts/tests/unit/_utils/test_rclone_cmd_builder.pct.py 7
...
# %% pts/tests/unit/_utils/test_rclone_cmd_builder.pct.py 8
...
# %% pts/tests/unit/_utils/test_rclone_cmd_builder.pct.py 9
...
# %% pts/tests/unit/_utils/test_rclone_cmd_builder.pct.py 10
...
# %% pts/tests/unit/_utils/test_rclone_cmd_builder.pct.py 17
...
# %% pts/tests/unit/_utils/test_rclone_cmd_builder.pct.py 19
