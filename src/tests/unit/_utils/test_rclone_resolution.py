# AUTOGENERATED! DO NOT EDIT! File to edit: pts/tests/unit/_utils/test_rclone_resolution.pct.py

__all__ = ['TestGetRcloneBinaryCaching', 'TestResolveRcloneBinary']

# %% pts/tests/unit/_utils/test_rclone_resolution.pct.py 2
import stat
import pytest
...
# %% pts/tests/unit/_utils/test_rclone_resolution.pct.py 3
...
# %% pts/tests/unit/_utils/test_rclone_resolution.pct.py 4
...
# %% pts/tests/unit/_utils/test_rclone_resolution.pct.py 5
