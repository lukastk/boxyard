# AUTOGENERATED! DO NOT EDIT! File to edit: pts/tests/unit/_utils/test_rclone_check.pct.py

__all__ = ['TestPushWouldTransfer', 'TestRcloneCheck', 'check', 'pair', 'run']

# %% pts/tests/unit/_utils/test_rclone_check.pct.py 2
import asyncio
import os
...
# %% pts/tests/unit/_utils/test_rclone_check.pct.py 3
...
# %% pts/tests/unit/_utils/test_rclone_check.pct.py 4
...
# %% pts/tests/unit/_utils/test_rclone_check.pct.py 5
