...
__all__ = ['TestAsyncThrottler', 'TestCheckLastTimeModified', 'TestCheckLastTimeModifiedWalkErrors', 'TestCountFilesInDir', 'TestGetBoxIndexNameFromSubPath', 'TestGetHostname', 'TestIsInEventLoop', 'TestModificationScanRespectsExcludes', 'TestRunCmdAsync', 'TestRunCmdAsyncTimeout', 'TestSoftInterruption', 'TestSoftInterruptionHandling', 'TestSuspendWatchdog', 'test_a_deletion_is_seen_as_a_modification', 'test_run_cmd_async_env_does_not_mutate_the_parent', 'test_run_cmd_async_env_replaces_the_environment', 'test_run_cmd_async_inherits_the_environment_by_default']
...
# %% pts/tests/unit/_utils/test_base_utils.pct.py 12
...
# %% pts/tests/unit/_utils/test_base_utils.pct.py 14
...
# %% pts/tests/unit/_utils/test_base_utils.pct.py 16
...
# %% pts/tests/unit/_utils/test_base_utils.pct.py 18
...
# %% pts/tests/unit/_utils/test_base_utils.pct.py 19
@pytest.mark.xfail(
    strict=True,
    reason=(
