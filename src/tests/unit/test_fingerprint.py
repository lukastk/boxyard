# AUTOGENERATED! DO NOT EDIT! File to edit: pts/tests/unit/test_fingerprint.pct.py

__all__ = ['SHAPES', 'test_a_file_named_like_a_dir_only_pattern_is_seen', 'test_a_glob_excluded_file_is_invisible_to_the_digest', 'test_a_preserved_mtime_restore_with_a_different_size_is_seen', 'test_a_same_size_same_mtime_edit_is_invisible_and_that_is_parity', 'test_an_empty_tree_digests_but_a_missing_one_is_none', 'test_an_unreadable_directory_raises_rather_than_shrinking_the_tree', 'test_an_untransportable_mode_change_is_deliberately_invisible', 'test_an_unusable_sidecar_reads_as_unknown_never_as_unchanged', 'test_changing_the_filter_rules_invalidates_the_baseline', 'test_excluded_churn_does_not_move_the_fingerprint', 'test_the_baseline_is_bound_to_the_sync_it_describes', 'test_the_sidecar_is_not_mistaken_for_a_sync_record', 'test_the_ten_change_shapes']

# %% pts/tests/unit/test_fingerprint.pct.py 2
import os
import shutil
import stat
import time
...
# %% pts/tests/unit/test_fingerprint.pct.py 3
...
# %% pts/tests/unit/test_fingerprint.pct.py 4
...
# %% pts/tests/unit/test_fingerprint.pct.py 5
...
# %% pts/tests/unit/test_fingerprint.pct.py 6
...
# %% pts/tests/unit/test_fingerprint.pct.py 7
...
# %% pts/tests/unit/test_fingerprint.pct.py 8
...
# %% pts/tests/unit/test_fingerprint.pct.py 9
...
# %% pts/tests/unit/test_fingerprint.pct.py 10
...
# %% pts/tests/unit/test_fingerprint.pct.py 11
...
# %% pts/tests/unit/test_fingerprint.pct.py 12
...
# %% pts/tests/unit/test_fingerprint.pct.py 13
...
# %% pts/tests/unit/test_fingerprint.pct.py 14
