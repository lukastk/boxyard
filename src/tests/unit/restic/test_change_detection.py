...
__all__ = ['box', 'count_restic_calls', 'gated', 'modified', 'pytestmark', 'run', 'test_CREATING_an_excluded_file_still_costs_a_check', 'test_RETARGETING_a_symlink_in_place_is_seen', 'test_a_clean_full_check_hands_back_a_stamp_that_closes_the_gate', 'test_a_directorys_mtime_alone_is_not_a_change', 'test_a_failed_dry_run_reports_changed', 'test_a_forgotten_parent_snapshot_reports_changed', 'test_a_missing_summary_reports_changed', 'test_activity_in_the_boxs_PARENT_directory_is_not_a_change', 'test_adding_a_file_is_seen', 'test_adding_a_nested_file_is_seen', 'test_adding_a_symlink_to_a_directory_is_seen', 'test_adding_a_symlink_to_a_file_is_seen', 'test_adding_an_EMPTY_file_is_seen', 'test_adding_an_empty_directory_is_seen', 'test_an_excluded_write_costs_a_check_and_answers_correctly', 'test_an_unchanged_box_is_not_modified', 'test_an_unreadable_directory_raises_rather_than_gating_it_away', 'test_an_untouched_box_makes_NO_restic_calls_at_all', 'test_an_unusable_parent_with_a_lone_deletion_reports_changed', 'test_chmod_is_seen', 'test_clearing_the_exec_bit_and_nothing_else_is_seen', 'test_ctime_is_what_makes_it_sound', 'test_deleting_a_file_is_seen', 'test_deleting_a_symlink_is_seen', 'test_deleting_an_empty_directory_is_seen', 'test_editing_content_is_seen', 'test_naming_an_excluded_DIRECTORY_lets_the_gate_fire', 'test_rclone_program_for_quotes_paths_it_cannot_control', 'test_renaming_a_directory_is_seen', 'test_renaming_a_file_is_seen', 'test_replacing_a_file_with_a_symlink_of_the_same_name_is_seen', 'test_rewriting_a_named_excluded_file_is_gated_out', 'test_setting_the_exec_bit_and_nothing_else_is_seen', 'test_synced_at_is_stamped_before_the_push_not_after', 'test_the_answer_is_stable_when_asked_twice', 'test_the_file_count_backstop_catches_a_deletion', 'test_the_gate_does_not_fire_without_a_recorded_time', 'test_the_gate_never_hides_a_change', 'test_the_slack_covers_a_coarse_filesystem_timestamp', 'test_touching_an_EXCLUDED_file_is_not_a_change']
...
# %% pts/tests/unit/restic/test_change_detection.pct.py 20
...
# %% pts/tests/unit/restic/test_change_detection.pct.py 22
...
# %% pts/tests/unit/restic/test_change_detection.pct.py 24
...
# %% pts/tests/unit/restic/test_change_detection.pct.py 25
...
# %% pts/tests/unit/restic/test_change_detection.pct.py 26
...
# %% pts/tests/unit/restic/test_change_detection.pct.py 27
...
# %% pts/tests/unit/restic/test_change_detection.pct.py 29
