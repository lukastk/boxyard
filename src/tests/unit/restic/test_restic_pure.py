# AUTOGENERATED! DO NOT EDIT! File to edit: pts/tests/unit/restic/test_restic_pure.pct.py

__all__ = ['DIFF_SAMPLE', 'SRC', 'test_apply_removals_deletes_files_and_dirs', 'test_apply_removals_does_not_follow_a_symlink_out', 'test_apply_removals_ignores_paths_that_are_already_gone', 'test_apply_removals_refuses_a_path_that_normalises_into_the_box_root', 'test_apply_removals_refuses_an_absolute_path', 'test_apply_removals_refuses_to_escape_the_data_dir', 'test_apply_removals_removes_a_dangling_symlink', 'test_conditions_line_up_with_sync_conditions', 'test_every_full_restore_reason_is_distinguishable', 'test_exclude_arg_is_not_a_bare_basename', 'test_exclude_arg_is_not_slash_anchored', 'test_exclude_arg_is_the_full_absolute_path', 'test_include_args_are_never_absolute', 'test_include_args_are_slash_anchored', 'test_include_args_do_not_double_the_slash', 'test_include_args_empty_for_no_paths', 'test_parse_diff_drops_the_root_itself', 'test_parse_diff_ignores_lines_outside_the_source', 'test_parse_diff_ignores_the_summary_lines', 'test_parse_diff_returns_paths_relative_to_the_source', 'test_parse_diff_splits_removed_from_everything_else', 'test_parse_diff_tolerates_a_trailing_slash_on_the_source', 'test_parse_pointer_reads_a_good_one', 'test_parse_pointer_returns_none_for_anything_unusable', 'test_pointer_sits_at_depth_2_beside_boxmeta', 'test_repo_path_does_not_collide_with_plain_data', 'test_repo_url_is_rclone_backed_and_beside_the_plain_parts', 'test_state_is_absent_before_anything_is_written', 'test_state_is_not_inside_the_synced_parts', 'test_state_records_a_timestamp_even_when_not_given', 'test_state_round_trips', 'test_state_write_is_atomic_leaving_no_temp_files', 'test_tree_modified_since_is_false_for_an_empty_tree', 'test_tree_modified_since_is_false_for_an_older_tree', 'test_tree_modified_since_sees_a_new_file', 'test_unusable_state_reads_as_unknown']

# %% pts/tests/unit/restic/test_restic_pure.pct.py 2
import json
import os
...
# %% pts/tests/unit/restic/test_restic_pure.pct.py 4
...
# %% pts/tests/unit/restic/test_restic_pure.pct.py 6
...
# %% pts/tests/unit/restic/test_restic_pure.pct.py 8
...
# %% pts/tests/unit/restic/test_restic_pure.pct.py 10
...
# %% pts/tests/unit/restic/test_restic_pure.pct.py 12
...
# %% pts/tests/unit/restic/test_restic_pure.pct.py 14
...
# %% pts/tests/unit/restic/test_restic_pure.pct.py 16
...
# %% pts/tests/unit/restic/test_restic_pure.pct.py 18
...
# %% pts/tests/unit/restic/test_restic_pure.pct.py 20
