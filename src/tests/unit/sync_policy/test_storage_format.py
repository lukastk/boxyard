...
__all__ = ['BASE_CONFIG', 'REMOTE_STORAGE', 'make_box', 'make_config', 'test_a_bad_format_in_a_box_conf_is_refused', 'test_a_converted_box_is_not_reverted_by_a_plain_policy', 'test_a_disagreement_on_another_dimension_still_raises_for_that_one', 'test_a_good_format_in_a_box_conf_is_accepted', 'test_a_group_policy_sets_the_intended_format', 'test_an_absent_key_loads_as_plain', 'test_an_existing_box_is_still_actually_plain', 'test_an_unknown_format_in_a_boxmeta_is_refused', 'test_an_unknown_format_is_refused_loudly', 'test_an_unknown_storage_location_falls_back_to_plain', 'test_an_unmatched_box_falls_through_to_the_default_policy', 'test_asking_for_restic_does_not_change_what_a_box_actually_is', 'test_boxmeta_round_trips_the_format_through_a_file', 'test_resolution_still_answers_the_other_dimensions', 'test_saving_a_converted_box_does_write_the_key', 'test_saving_a_plain_box_writes_no_storage_format_key', 'test_storage_format_is_a_box_overridable_dimension', 'test_the_default_is_plain_for_a_local_storage_location', 'test_the_default_is_restic_for_a_remote_storage_location', 'test_the_default_policy_is_the_floor', 'test_the_policy_field_accepts_only_the_known_formats', 'test_two_policies_agreeing_is_not_a_conflict', 'test_two_policies_disagreeing_is_refused_not_joined']
