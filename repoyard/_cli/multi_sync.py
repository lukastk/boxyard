# AUTOGENERATED! DO NOT EDIT! File to edit: ../../../pts/mod/_cli/multi-sync.pct.py.
...
def cli_multi_sync(
    ...
    # %% auto 0
    __all__ = ['config', 'repoyard_meta', 'sync_stats', 'finish_monitoring_event', 'console', 'sync_task', 'final_sync_stat_board',
               'get_status_lines', 'get_sync_stat_board', 'print_finished']
    
    # %% ../../../pts/mod/_cli/multi-sync.pct.py 4
    ...
    # %% ../../../pts/mod/_cli/multi-sync.pct.py 11
    ...
    # %% ../../../pts/mod/_cli/multi-sync.pct.py 13
    ...
    # %% ../../../pts/mod/_cli/multi-sync.pct.py 15
    sync_stats = {}
    ...
    # %% ../../../pts/mod/_cli/multi-sync.pct.py 19
    from .._utils import is_in_event_loop
