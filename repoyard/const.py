...
__all__ = ['pkg_path', 'DEFAULT_CONFIG_PATH', 'DEFAULT_DATA_PATH', 'DEFAULT_USER_REPOS_PATH', 'DEFAULT_USER_REPO_GROUPS_PATH',
           'SYNC_RECORDS_REL_PATH', 'REMOTE_REPOS_REL_PATH', 'REMOTE_BACKUP_REL_PATH', 'REPO_DATA_REL_PATH',
           'REPO_METAFILE_REL_PATH', 'REPO_CONF_REL_PATH', 'SOFT_INTERRUPT_COUNT', 'DEFAULT_FAKE_STORE_REL_PATH',
           'DEFAULT_RCLONE_EXCLUDE', 'REPO_TIMESTAMP_FORMAT', 'REPO_TIMESTAMP_FORMAT_DATE_ONLY',
